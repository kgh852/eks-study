...
const file_proto_user_proto_rawDesc = "" +
	...
	"\x05email\x18\x02 \x01(\tR\x05email2y\n" +
	"\vUserService\x121\n" +
	"\aGetUser\x12\x17.user.v1.GetUserRequest\x1a\r.user.v1.User\x127\n" +
	"\n" +
	"CreateUser\x12\x1a.user.v1.CreateUserRequest\x1a\r.user.v1.UserB<Z:github.com/finn/eks-study/user-service/proto/userv1;userv1b\x06proto3"
...
var file_proto_user_proto_depIdxs = []int32{
	...
	0, // 3: user.v1.UserService.CreateUser:output_type -> user.v1.User
